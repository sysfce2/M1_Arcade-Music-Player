...
{
	vgm_header_set(K054539_chips.chip[0].vgm_idx, 0x01, flags);
	K054539_flags = flags;
}
...
static void K054539_init_chip(int chip, const struct MachineSound *msound)
{
	...
	K054539_chips.chip[chip].vgm_idx = vgm_open(VGMC_K054539, K054539_chips.intf->clock);
	vgm_header_set(K054539_chips.chip[chip].vgm_idx, 0x01, K054539_flags);
	vgm_write_large_data(K054539_chips.chip[chip].vgm_idx, 0x01, K054539_chips.chip[chip].rom_size, 0x00, 0x00, K054539_chips.chip[chip].rom);
...
static void K054539_w(int chip, offs_t offset, data8_t data) //*
{
	...
	vgm_write(K054539_chips.chip[chip].vgm_idx, 0x00, offset, data);
